...
public class FingerGameClient {
	...
	protected static JButton jbnButton[] = new JButton[20];
	...
	public void connectedGame() {
		...
		btn_l1.setBounds(280, 0, 200, 200);
		frame.getContentPane().add(btn_l1);

		btn_r1 = new JButton(r2_1);
		...
		btn_r1.setBounds(60, 0, 200, 200);
		frame.getContentPane().add(btn_r1);

		// server hand
		btn_l2 = new JButton(l1_1);
		...
		btn_l2.setBounds(60, 260, 200, 200);
		frame.getContentPane().add(btn_l2);

		btn_r2 = new JButton(r1_1);
		...
		btn_r2.setBounds(280, 260, 200, 200);
	...
	public static int poking_number = 0;
	...
	static FingerGameClient window;
	...
	public static void main(String[] args) {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "IP address is wrong");
		} catch (IOException e) {
			// TODO Auto-generated catch block
			textArea.setText(textArea.getText().trim() + "\nunconnected...");
			JOptionPane.showMessageDialog(null, "Server is not longer available");
		}
	}
	...
	public FingerGameClient() throws IOException {
		initialize();
	}
